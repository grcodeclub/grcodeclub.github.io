...
if (addFooter) {
    ...
    <li class="social-item"> <a class="github" href="#" onclick="copyRealUrl(); return false;" ><span></span> <span></span> <span></span> <span></span><i class="fa fa-share-alt" aria-hidden="true"></i></a></li>
 </ul>`;
