...
if (addFooter) {
    ...
    <li class="social-item"> <a class="github" href="#" onclick="shareURL(); return false;" ><span></span> <span></span> <span></span> <span></span><i class="fa fa-share" aria-hidden="true"></i></a></li>
 </ul>`;
