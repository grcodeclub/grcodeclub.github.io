...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.querySelector('.category-checkbox')) { addScript('https://grcodeclub.gr/js/search/tableSearchWithCheckboxes.js');}
    if (document.querySelector('.search_table_page')) { addScript('https://grcodeclub.gr/js/search/tables-pages.js');}
