...
fetch(currentURL)
    .then(response => {
        ...
        if (response.ok) {
            ...
            else if (currentURL.startsWith('https://grcodeclub.gr/more/create') && !currentURL.startsWith('https://grcodeclub.gr/more/create/post')) {addScript('https://grcodeclub.github.io/js/add/menu/create.js');} 
